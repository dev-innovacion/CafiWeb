                            ...
                            '<nav class="jsPanel-navbar-hdr navbar navbar-default" role="navigation">'+
                                ...
                                '<div class="collapse navbar-collapse">'+
                                    '<ul class="nav navbar-nav navbar-right jsPanel-controls">'+
                                       '<li class="jsPanel-hdr-r-btn-min"><a   href="#"><span class="glyphicon glyphicon-minus btn-mini  icon-minus"></span></a></li>' +
                                        '<li class="jsPanel-hdr-r-btn-max"><a   href="#"><span class="glyphicon glyphicon-fullscreen btn-mini purple icon-android"></span></a></li>' +
                                        '<li class="jsPanel-hdr-r-btn-close"><a href="#"><span class="glyphicon glyphicon-remove btn-mini red delete"></span></a></li>' +
                                     '</ul>' +
                                '</div><!-- /.navbar-collapse -->'+
