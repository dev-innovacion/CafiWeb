            ...
            public void createCatalog(String idlocationroot,String iduser)
            {
               ...
               // JObject datainfoString = JsonConvert.DeserializeObject<JObject>(dataInfo);
                ...
                try
                {
                    ...
                    string fields = "'_id','objectReference','objectReference_name','EPC','serie','location','location_name','marca','modelo','Creator','number','conjuntoName','department','label','date','quantity','user_label'";
                    string values = "'0','5','6','10','9','16','4','7','8','17','1','2','3','11','12','14','13'";
