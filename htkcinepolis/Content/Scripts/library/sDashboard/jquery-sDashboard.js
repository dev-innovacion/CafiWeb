...
( function(factory) {"use strict";
		...
		$.widget("mn.sDashboard", {
			...
			_constructWidget : function(widgetDefinition) {
				...
				var widgetHeader = $("<div/>").addClass("sDashboardWidgetHeader sDashboard-clearfix widgetclient titleclient");
				...
				if (widgetDefinition.hasOwnProperty("enableRefresh") && widgetDefinition.enableRefresh) {
					var refreshButton = $('<div title="Recargar" class="sDashboard-icon sDashboard-refresh-icon "></div>');
					//add refresh button
			...
			_removeWidgetFromWidgetDefinitions : function(widgetId) {
			    ...
			    var widget1 = this.element.find("li" + idSelector);
			    widget1 = widget1.find(".widgetid");
			    widget1 = widget1.data("idwidget");
			    if (!widget1) {
			        throw "Error";
			    } else {
			        jQuery.ajax({

			            url: "/Reports/Reports/deleteWidget",
			            data: { id: widget1 },
