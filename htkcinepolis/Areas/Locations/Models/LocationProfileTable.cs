...
namespace RivkaAreas.Locations.Models
{
    public class LocationProfileTable : MongoModel
    {
        ...
        public void removeField(String fieldID) {
            ...
            List<BsonDocument> documentsList = get("LocationcustomFields.fields.fieldID", fieldID); //each profile that has the field
            foreach( BsonDocument document in documentsList){
                BsonArray tabsObject = (BsonArray)document.GetElement("LocationcustomFields").Value;
