                       ...
                       // JObject profobj = JsonConvert.DeserializeObject<JObject>(profmove);
                        ...
                        if (item["typeMovement"].ToString() == "delete")
                        {
                         ...
                         /* try
                          ...
                          try
                          {
                              item["objects"] = "<div class='btn-group'><button class='viewdetail btn btn-mini blue fileinput-button' data-id='" + item["_id"].ToString() + "'  data-original-title='ver Detalle' rel'tooltip' data-placement='top'> <i class='icon-tag'></i></button></div>";
                          }
                          catch { }
                          try{
                        ...
                        try
                        {
                            if (  item["images"].ToString() != "sin Imagen")
                               {
                                   item["images"] = "<div class='btn-group'><button class='viewimg btn btn-mini blue fileinput-button' data-id='" + item["_id"].ToString() + "' data-target='#" + item["_id"].ToString() + "' data-toggle='modal'  data-original-title='ver Imagenes' rel='tooltip' data-placement='top'><i class='icon-picture'></i></button></div>";
                                }
                        }
                        catch { }
                          result.Add(item);
