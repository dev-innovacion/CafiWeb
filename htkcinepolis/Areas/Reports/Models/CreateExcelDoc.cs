   ...
   public class CreateExcelDoc
    {
        ...
        public void SetPicture(int extra=0)
        {
            int colm = (extra == 0) ? 3 : 4;
            Excel.Range oRange = (Excel.Range)worksheet.Cells[1, colm];
        ...
        public void addFast(int minrow,int mincol,int maxrow,int maxcol,string[,] arr)
        {
          ...
          //  theRange.Interior.Color = System.Drawing.Color.Gainsboro.ToArgb();
            theRange.Borders.Weight = 3d;
            theRange.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignRight;
          
        }
        public void addHeaderFast(int minrow, int mincol, int maxrow, int maxcol, string[,] arr,string b, bool font, int size, string fcolor)
        {
            Excel._Worksheet sheet = app.ActiveSheet as Excel._Worksheet;
            Excel.Range sheetCells = sheet.Cells;
            Excel.Range cellFirst = sheetCells[minrow, mincol] as Excel.Range;
            ...
            {
                case "YELLOW":
                    theRange.Interior.Color = System.Drawing.Color.DodgerBlue.ToArgb();
                    break;
                case "FB":
                    theRange.Interior.Color = System.Drawing.Color.CornflowerBlue;
                    break;
                case "GRAY":
                    theRange.Interior.Color = System.Drawing.Color.Gray.ToArgb();
                    break;
                case "BLUE":
                    theRange.Interior.Color = System.Drawing.Color.DarkBlue.ToArgb();
                    break;
                case "GAINSBORO":
                    theRange.Interior.Color = System.Drawing.Color.Gainsboro.ToArgb();
                    break;
                case "Turquoise":
                    theRange.Interior.Color = System.Drawing.Color.Turquoise.ToArgb();
                    break;
                case "PeachPuff":
                    theRange.Interior.Color = System.Drawing.Color.PeachPuff.ToArgb();
                    break;
                default:
                    theRange.Interior.Color = System.Drawing.Color.Azure;
                    break;
            }

            theRange.Borders.Color = System.Drawing.Color.Black.ToArgb();
            theRange.Borders.Weight = 3d;
            theRange.Font.Bold = font;
            theRange.ColumnWidth = size;
            if (fcolor.Equals(""))
            {
                theRange.Font.Color = System.Drawing.Color.Snow.ToArgb();
            }
            else
            {
                theRange.Font.Color = System.Drawing.Color.Black.ToArgb();
            }
            theRange.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
