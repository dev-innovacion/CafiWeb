...
namespace RivkaAreas.User.Models
{
    ...
    public class UserTable : MongoModel
    {
        ...
        public List<BsonDocument> searchUsers(string texto="")
        {
            //).SetSortOrder(SortBy.Ascending("user")
            ...
            if (texto != "")
            {
                ...
                listqueries.Add(Query.Matches("user", match));
                listqueries.Add(Query.Matches("lastname", match));
               // listqueries.Add(Query.Matches("email", match));
               // listqueries.Add(Query.Matches("alias", match));
