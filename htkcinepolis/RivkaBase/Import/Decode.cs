...
namespace Rivka.Import
{
    public class Decode
    {
        public class Context_Compress
        {
        ...
        public class Context_Compress_Data
        {
        ...
        public static Context_Compress_Data writeBit(int value, Context_Compress_Data data)
        {
        ...
        public static Context_Compress_Data writeBits(int numbits, int value, Context_Compress_Data data)
        {
        ...
        public static Context_Compress produceW(Context_Compress context)
        {
       ...
       public static Context_Compress decrementEnlargeIn(Context_Compress context)
        {
        ...
        public static int readBit(Decompress_Data data)
        {
       ...
       public static int readBits(int numBits, Decompress_Data data)
        {
       ...
       public  string decompress1(string compressed)
       {
